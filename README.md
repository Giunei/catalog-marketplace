...
The Microservice was developed by [Fernanda Kipper](https://github.com/Fernanda-Kipper) in her YouTube channel, to solve the [AnotaAi Backend Challenge](https://github.com/githubanotaai/new-test-backend-nodejs).
...
```bash
git clone https://github.com/Giunei/catalog-marketplace.git
```
